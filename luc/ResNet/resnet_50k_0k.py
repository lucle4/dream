...
img_dir_original = os.path.join(directory, 'original dataset/samples_original_50k')
label_dir_original = os.path.join(directory, 'original dataset/original_dataset_50k.csv')
...
for epoch in range (n_epochs):
    ...
    with open(r'stats_50k_0k.txt', 'w') as fp:
