...
for epoch in range(n_epochs):
    ...
    with open(r'stats 3_4_2.txt', 'w') as fp:
    ...
    with torch.no_grad():
        ...
        transform_PIL(img_list[-1]).save('samples 3_4_2/epoch {}.png'.format(epoch+1))

    if (epoch+1) % 20 == 0:
        torch.save(G.state_dict(),'checkpoints 3_4_2/checkpoint epoch {}.pt'.format(epoch+1))
