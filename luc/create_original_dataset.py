...
img_dir = os.path.join(directory, 'samples_original_20k')
csv_dir = os.path.join(directory, 'original_dataset_20k.csv')
...
for i, (input, target) in enumerate(train_loader):
    ...
    save_image(input, 'samples_original_20k/{} {}.png'.format(classes[target], i+1))
