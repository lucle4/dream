...
img_dir_no_interpolation = os.path.join(directory, 'no interpolation dataset/samples_no_interpolation_30k')
label_dir_no_interpolation = os.path.join(directory, 'no interpolation dataset/no_interpolation_dataset_30k.csv')
