...
img_dir_dream_1 = os.path.join(directory, 'dream 1 dataset/samples_dream_1_40k')
label_dir_dream_1 = os.path.join(directory, 'dream 1 dataset/dream_1_dataset_40k.csv')
